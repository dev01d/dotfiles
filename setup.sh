...
function installBrew() {
  if [ ! -e /usr/local/bin/brew ]; then
    ...
    brewApps=( ansible bash bat clamav ddrescue exa git go htop hexyl mas nmap python ruby shellcheck sshfs tmux trash tree unrar watch wget whois xz youtube-dl zsh)
